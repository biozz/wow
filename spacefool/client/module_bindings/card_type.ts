...
import { Rank as __Rank } from "./rank_type";
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      new ProductTypeElement("suit", __Suit.getTypeScriptAlgebraicType()),
      new ProductTypeElement("rank", __Rank.getTypeScriptAlgebraicType()),
    ]);
  }
